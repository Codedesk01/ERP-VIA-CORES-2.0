...
function iniciarCronometroETrabalho() { // O nome da função foi mantido para compatibilidade
    ...
    // Esconde o botão "Iniciar" e mostra apenas o botão "Enviar para Expedição".
...
function enviarParaExpedicao() {
    ...
    // Define o usuário que finalizou a tarefa no momento do envio.
...
logAction({
    ...
    detalhes: { lote: itemMovido.lote, sku: itemMovido.sku, pedidoId: itemMovido.pedidoId }
});
}
